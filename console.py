...
city1 = City("Madrid", True, country1)
city_repository.save(city1)
city2 = City("Athens", True, country2)
city_repository.save(city2)
city3 = City("Rome", True, country3)
city_repository.save(city3)
city4 = City("Tokyo", False, country4)
city_repository.save(city4)
city5 = City("Antananarivo", False, country5)
city_repository.save(city5)
city6 = City("Johannesburg", True, country6)
city_repository.save(city6)
city7 = City("Bridgetown", True, country7)
city_repository.save(city7)
city8 = City("Pyongyang", False, country8)
